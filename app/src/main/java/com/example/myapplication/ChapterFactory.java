...
public class ChapterFactory {
    ...
    public ArrayList<Chapter> getChapters(){
        ...
        "L'opera è divisa in sette libri, tanti quanti gli anni di studio a Hogwarts, " +
                ...
                "responsabile di altre numerose morti oltre a quella dei suoi genitori. ",3.1f);
        ...
        Chapter chap3 = new Chapter(2, 1, "Assassinio sull'Orient Express (Murder on the Orient Express) " +
                ...
                "Century Fox, mentre in quelle italiane ha esordito il 30 novembre 2017 distribuito da 20th Century Fox Italia.",2.3f);
        ...
        Chapter chap4 = new Chapter(2, 2, "Gerusalemme, 1934. Il detective belga Hercule Poirot risolve un furto alla Basilica" +
                ...
                " costringendolo a fermarsi in attesa di soccorso dalla stazione più vicina.",1.2f);
        ...
        Chapter chap7 = new Chapter (4,1,"Nel 1765 c'era una specie protetta di foglie chiamata Fabrizio. Faceva la clorofila fotosintosa.\n" +
                "Da allora decise di fermarsi perché era troppo faticoso. Tutto il pianeta morì.",3.2f);
    ...
    public double getAverageValutationBook (int bookId){
        ArrayList<Chapter> chapters = this.getChaptersByBookId(bookId);
        double average=0;
        int contatore=0;
        double total = 0;
        for(Chapter c : chapters){
